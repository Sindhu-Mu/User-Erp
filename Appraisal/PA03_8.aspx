<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/FullLength.master" AutoEventWireup="true" CodeFile="PA03_8.aspx.cs" Inherits="Appraisal_PA03_8" %>
                            ...
                            <asp:UpdatePanel ID="up3A" runat="server">
                                <ContentTemplate>
                                    <table class="entry">
                                        ...
                                        <tr>
                                            <td>
                                                <asp:TextBox ID="txtDetail" Width="500px" runat="server" MaxLength="1000" TextMode="MultiLine" Rows="10"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:GridView ID="gridData8A" runat="server" AutoGenerateColumns="false" GridLines="None"
                                                    AllowPaging="false" CssClass="gridDynamic" AlternatingRowStyle-CssClass="alt"
                                                    SelectedRowStyle-CssClass="pgr" DataKeyNames="PA03_8A_ID" OnRowDeleting="gridData_RowDeleting">
                                                    <Columns>
