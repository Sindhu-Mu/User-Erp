<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PurReqMain.aspx.cs" Inherits="Purchase_PurReqMain" MasterPageFile="~/MasterPages/FullLength.master" Title="ERP|Purchase Requisition" %>
                        ...
                        <ajaxToolkit:TabPanel ID="TabPanel1" HeaderText="Purchase Requisition" runat="server">
                            <ContentTemplate>
                                <table style="width: 100%">
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <asp:GridView ID="gvItemDetail" runat="server" AutoGenerateColumns="False" CssClass="gridDynamic" OnRowDeleting="gvItemDetail_RowDeleting">
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="ORG_NAME" HeaderText="Vendor Name"></asp:BoundField>
                                                            ...
                                                            <td>
                                                                <asp:GridView ID="gvRequest" runat="server" AutoGenerateColumns="False" CssClass="gridDynamic" DataKeyNames="PUR_REQ_ID" OnRowCommand="gvRequest_RowCommand">
                                                                    <Columns>
                                                                        ...
                                                                        <asp:BoundField HeaderText="Pur.No" DataField="PUR_REQ_NO" />
                                                                        <asp:BoundField HeaderText="Store" DataField="STO_NAME" />
                                                                        <asp:BoundField HeaderText="Created By" DataField="EMP_NAME" />
                                                                        <asp:BoundField HeaderText="On Date" DataField="IN_DT" DataFormatString="{0:dd/MM/yyyy}" />
                                                                        <asp:BoundField HeaderText="Remark" DataField="REMARK" />
                                                                        <asp:CommandField ButtonType="Image" HeaderText="Edit" SelectImageUrl="~/Siteimages/edit.gif" ShowSelectButton="True">
                                                                            <ItemStyle Width="40px" />
                                                                        </asp:CommandField>
                                                                        <asp:ButtonField ButtonType="Button" CommandName="Detail" Text="Detail" HeaderText="Items" />
                                                                    </Columns>
                                                                </asp:GridView>
                                                            </td>
                                                            <td>
                                                                <asp:GridView ID="gvRequestItem" runat="server" AutoGenerateColumns="False" CssClass="gridDynamic" DataKeyNames="PUR_REQ_ID" OnRowCommand="gvRequest_RowCommand">
                                                                    <Columns>
                                                                        <asp:TemplateField HeaderText="S.No.">
                                                                            <ItemTemplate>
                                                                                <%# ((GridViewRow)Container).RowIndex + 1%>
                                                                        ...
                                                                        <asp:BoundField HeaderText="Vendor" DataField="ORG_NAME" />
                                                                    </Columns>
                                                                </asp:GridView>
                                                            </td>
                                                        </tr>
