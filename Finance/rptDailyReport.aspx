<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/FullLength.master" AutoEventWireup="true" CodeFile="rptDailyReport.aspx.cs" Inherits="Report_rptDailyReport" %>
                        ...
                        <div style="width: 100%;">
                            <div style="text-align: justify; vertical-align: top;">
                                <div style="float: left; width: 20%; padding-left: 20px">
                                    <img src="../Siteimages/PrintLogo.png" alt="" style="width: 90%;" />
                                </div>
                                <div style="float: left; text-align: center; width: 70%; font-size: 16px">
                                    <span style="font-size: 23px">Mangalayatan University</span><br />
                                    Extended NCR, 33rd Milestone Mathura, Highway, Beswan<br />Aligarh, Uttar Pradesh 202145.<br />
                            ...
                            <div style="font-size: 15px; text-align: center; border-bottom: 1px solid black; border-top: 1px solid black;">
                                Daily Payment Report<asp:Label ID="lblSession" runat="server"></asp:Label>
                            </div>
                        </div>
                        <div style="width: 100%;">
                            <div style="clear: both;"></div>
                            <div>
                                <asp:GridView ID="gridSummay" runat="server" AutoGenerateColumns="true" Caption="Fee Payment" EmptyDataText="No Record Found." ShowFooter="true" CssClass="gridPrint" Width="99%">
                                    <Columns>
                            ...
                            <div style="clear: both;"></div>
                            <div>
                                <asp:GridView ID="gridSummay2" runat="server" AutoGenerateColumns="true" Caption="Document Payment" EmptyDataText="No Record Found." ShowFooter="true" CssClass="gridPrint" Width="99%">
                                    <Columns>
                                        <asp:TemplateField HeaderText="S.No.">
                                            <ItemTemplate>
                                                <%# ((GridViewRow)Container).RowIndex + 1%>.
