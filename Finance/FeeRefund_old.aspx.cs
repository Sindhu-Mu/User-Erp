...
public partial class Finance_BankAccount : System.Web.UI.Page
{
    ...
    void Add()
    {
        ...
        for (int i = 0; i < nodeList.Count; i++)
        {
            ...
            {
                ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "clientScript", "alert('This Reference no detail alrady inserted!!')", true);
                return;
            }
        }
            ...
            //{
                ...
                foreach (GridViewRow itm in gvFees.Rows)
                {
                    ...
                    if (chk.Checked)
                    {
                        ...
                        txtAmount = Convert.ToDouble(itm.Cells[1].Text);
                ...
                if (FeeRfdTranID != "")
                {
                    ...
                    ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "clientScript", "window.open('prtFeeRefundReceipt.aspx?=" + FeeRfdTranID + "','_blank','scrollbars=1')", true);
                }
                txtData.Text = txtEnrollment.Text = "";
