<%@ Page Language="C#" AutoEventWireup="true" CodeFile="prtMultiMarks.aspx.cs" Inherits="Academic_prtMultiMarks" %>
    ...
    <form id="form1" runat="server">
        <asp:Repeater ID="repMarks" runat="server">
            ...
            <ItemTemplate>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="true" Width="99%"
                            CellPadding="2">
                            <Columns>
                ...
                <tr>
                    <td>
                        <hr style="visibility: hidden; color: White; background-color: White; page-break-after:always" />
                    </td>
                </tr>
            </ItemTemplate>
            <FooterTemplate>
