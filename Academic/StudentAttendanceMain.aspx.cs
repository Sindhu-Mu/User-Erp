...
public partial class Academic_StudentAttendanceMain : System.Web.UI.Page
{
    ...
    {
        Initialize();
        btnLoadSlot.Attributes.Add("Onclick", "return validation()");
    }
    protected void btnLoadSlot_Click(object sender, EventArgs e)
    {
        if (DateTime.Today.CompareTo(commonFunctions.GetDateTime(txtDate.Text)) < 0)
        {
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "clientScript", "alert('Entered date cannot be greater than today')", true);
            return;
        }
        else
        {
            ...
            fillFunctions.Fill(ddlTime, AcaBll.GetTimeSlotCommand(AcaBal), true, FillFunctions.FirstItem.Select);
        }
    }
    protected void ddlTime_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            AcaBal.Id = ddlTime.SelectedValue;
