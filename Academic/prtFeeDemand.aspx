<%@ Page Language="C#" AutoEventWireup="true" CodeFile="prtFeeDemand.aspx.cs" Inherits="Academic_prtFeeDemand" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Fee Demand</title>
    <style type="text/css">
        .auto-style1 {
            width: 98px;
        }
               ...
               <table style="font-family: Arial; font-size: 10pt; text-align: justify; width: 700px; border-collapse: collapse">
                        ...
                        <td>
                            <table style="border-collapse: collapse; width: 60%;float:left">
                                <tr>
                                     ...
                                     <td>Ref.No.:-<asp:Label ID="lblRef" runat="server"></asp:Label></td>                                 
                    ...
                    <tr>
                        ...
                        <td class="auto-style1">&nbsp;</td>
                                ...
                                <tr>
                                    <td class="auto-style1">ENROLLMENT:-</td><td><asp:Label ID="lblEnroll" runat="server"></asp:Label></td>
                                </tr>
                           <tr>
                                      <td class="auto-style1">NAME:-</td><td><asp:Label ID="lblName" runat="server"></asp:Label></td>
                                </tr>
                                <tr>
                                    <td class="auto-style1">COURSE:-
                    
                        </td><td><asp:Label ID="lblCourse" runat="server"></asp:Label></td>
                                </tr>
                                <tr>
                                    <td class="auto-style1">
                            SEMESTER:-
                  
                        </td><td><asp:Label ID="lblSem" runat="server"></asp:Label></td>
                                </tr>
                                <tr>
                                    <td class="auto-style1">
                            SECTION:-
                            </td><td><asp:Label ID="lblSec" runat="server"></asp:Label></td>
                                </tr>
                            </table>
                            </td>
                        </tr>
                    <tr>
                        ...
                        <tr style="text-align: left;">
                            <td>&nbsp; <b>Dear</b> &nbsp;<asp:Label ID="lblParent1" runat="server"></asp:Label></td>
                        </tr>
                        <tr>
                   ...
                   --%>           
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="gvOpening" runat="server" Width="90%" AutoGenerateColumns="false" ShowFooter="True">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="DAMT" HeaderText="Upcoming Semester(2017-18) (Amount in Rupees)">
