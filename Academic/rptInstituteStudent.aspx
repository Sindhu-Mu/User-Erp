<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/FullLength.master" AutoEventWireup="true" CodeFile="rptInstituteStudent.aspx.cs" Inherits="Academic_rpt_INSTITUTE_STUDENT" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="container">
        <div class="heading">
            <h2>Institution Student Report
            </h2>
        </div>
        <div>
            <table>
