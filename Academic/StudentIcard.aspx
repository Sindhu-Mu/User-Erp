<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/FullLength.master" AutoEventWireup="true" CodeFile="StudentIcard.aspx.cs" Inherits="Academic_StudentIcard" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="body_h" style="text-align: center">
        <table style="width: 90%; margin: 20px;">
            <tr>
                ...
                <td>&nbsp;</td>
                <th>Batch<span class="required">*</span></th>
                <th></th>
            </tr>
            <tr>
            ...
            <tr>
                <th style="vertical-align: top">Semester<span class="required">*</span></th>
                <td>&nbsp;</td>
                <th>Printed<span class="required">*</span></th>
                <td>&nbsp;</td>
                <th>Enrollment<span class="required">*</span></th>
                <td>&nbsp;</td>
                <th>Counting<span class="required">*</span>
                </th>
                <th></th>
            </tr>
            <tr>
    ...
    <div id="body_c" style="text-align: center; margin: 20px">
        <asp:GridView runat="server" ID="cardGrid" Width="90%" AutoGenerateColumns="False" DataKeyNames="ENROLLMENT_NO" CssClass="gridDynamic">
            <Columns>
                ...
                <asp:BoundField DataField="Stu_Mobile" HeaderText="Contact No" />
                <asp:TemplateField>
                    <ItemTemplate>
    ...
    <div id="body_f" style="text-align: center; margin: 20px;">
        <asp:Button ID="print" runat="server" Text="Print" OnClick="print_Click" PostBackUrl="StudentIcardPrint.aspx" />
        <br />
