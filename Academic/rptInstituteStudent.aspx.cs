...
public partial class Academic_rpt_INSTITUTE_STUDENT : System.Web.UI.Page
{
    ...
    {
        ViewState["ID"] = DataBasefunction.GetSingleData(QueryFunction.GetCommand(QueryFunctions.QueryBaseType.Emp_Ins, Session["UserId"].ToString()));
        FillFunctin.Fill(ddlCourse, QueryFunction.GetCommand(QueryFunctions.QueryBaseType.ProgramByIns, ViewState["ID"].ToString()), true, FillFunctions.FirstItem.All);
