<%@ Page Language="C#" AutoEventWireup="true" CodeFile="prtStuSemReport.aspx.cs" Inherits="Academic_prtStuSemReport" %>
                    ...
                    <td style="padding-left: 10px;">
                        <table style="width: 100%; border-collapse: collapse; border-spacing: 0px;">
                            ...
                            <tr>
                                ...
                                <td style="text-decoration: underline; text-align: center; font-weight: bold;">Sub: Student Academic Report
                                    <br />
                                    ...
                                    <table style="width: 100%; border-collapse: collapse; border-spacing: 0px; text-align: left; font-size: 16px">
                                        ...
                                        <tr>
                                            <td>As an endeavour on our part to create a strong bond between the parents and the University,
                                                we are providing the semester status report of your ward.
                                                <br />
