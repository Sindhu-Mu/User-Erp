<%@ Page Language="C#" AutoEventWireup="true" CodeFile="prtSalarySlip.aspx.cs" Inherits="PayRoll_prtSallarySlip" %>
...
<body bgcolor="#f5f5f5" style="background-image:url('..Siteimages/mu_logo.jpg'); background-repeat: no-repeat; background-position: center;">
...
<table id ="tblPay" runat ="server" border="0" width="100%" cellpadding="0" style="border-collapse: collapse">
				...
				<table border="0" width="100%" cellpadding="0" style="border-collapse: collapse; font-family:Times New Roman; font-size: 12px; ">
					<tr>
						<td height="20" width="100%" align="center" >
                            <img src="../muImages/image001.jpg" style="height: 100px" width="300" alt="" /><br />
    ...
    <tr>
        ...
        <td align="right" style="padding-left: 20px; font-size: 11px; font-family: Tahoma">
            </td>
