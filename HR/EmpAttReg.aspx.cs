...
public partial class HR_EmpAttReg : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            EmpTodyaAtt.ShowAttendance(DateTime.Now, Session["UserId"].ToString());
    ...
    protected void gridAttendance_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            EmpTodyaAtt.ShowAttendance(CommonFunction.GetDateTime(gridAttendance.DataKeys[Convert.ToInt32(e.CommandArgument)].Value.ToString()), Session["UserId"].ToString());
