...
<body>
                        ...
                        <div id="apDiv1">
                            <div id="apDiv2">
                               <%#DataBinder.Eval(Container.DataItem,"DEPT_ALIAS")%>
                                <%--<img alt="Department Image" src="<%#DataBinder.Eval(Container.DataItem,"DEPT_IMAGE")%>" style="width: 27px; height: 230px;" />--%>

                            </div>
                            <div id="apDiv3">
                                <img alt="Employee Image" style="width: 90px; height: 100px" src="<%# DataBinder.Eval(Container.DataItem, "EMP_IMAGE") %>" /></div>
                            <div id="apDiv4" style="font-size: 10px; text-align: center"><%# DataBinder.Eval(Container.DataItem, "EMP_NAME") %><br />
                                <%# DataBinder.Eval(Container.DataItem, "DESIG_NAME") %></div>
                            <div id="apDiv5" style="background-color: <%# DataBinder.Eval(Container.DataItem, "COLOR") %>">
                                <div id="apDiv7">
                                    <img src="../images/sign/registrar.png" alt="sign" style="width: 50px; height: 25px; border: 0px" /></div>
    ...
    Blood Group : <%# DataBinder.Eval(Container.DataItem, "Blood_Group")%></td>
                            ...
                            <div id="apDiv6">
                                 <%#DataBinder.Eval(Container.DataItem,"SESSION_VALUE")%>
