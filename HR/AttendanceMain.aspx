<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/FullLength.master" AutoEventWireup="true" CodeFile="AttendanceMain.aspx.cs" Inherits="HR_AttendanceMain" %>
                            ...
                            <td style="vertical-align: top;">
                                <table>
                                    <tr>
                                        ...
                                        <td>&nbsp;</td>
                                        <td>
                                            <asp:TextBox ID="Txtxml" runat="server" Visible="false"></asp:TextBox></td>
                                    </tr>
                                    <tr>
                                        <td>
