...
public partial class Control_StudentPassout : System.Web.UI.UserControl
{
    ...
    public void ShowStudent(string StuAdmNo)
    {
        ...
        cmd = new SqlCommand();
        cmd.CommandText = "GET_STU_SHORT_INFO_PASSOUT";
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            lblStatus.Text = dt.Rows[0]["STU_STS_VALUE"].ToString();
        }
    }
    public void Clear()
    {
