<%@ Control Language="C#" AutoEventWireup="true" CodeFile="StuFullProfileD.ascx.cs" Inherits="Control_StuFullProfileD" %>
...
<div id="div1" runat="server">
    ...
    <div id="div2" class="main-div-stu" runat="server">
        ...
        <div class="right-area">
            ...
            &nbsp;Batch:-<asp:Label ID="lblBatch" runat="server" CssClass="label-detail"></asp:Label>
            Institute:- 
        ...
        <tr>
            <td>
                <ajaxToolkit:TabContainer ID="step1" runat="server" AutoPostBack="true" ActiveTabIndex="0" OnActiveTabChanged="step1_ActiveTabChanged1">
                                ...
                                <tr>
                                    <td style="width: 50%; vertical-align: top">
                                        <table>
                                            <tbody>
                                                <%--  <tr>
                                                                            <th style="background-color: #000000; color: White; height: 20px;" colspan="3">1.Personal Information</th>
                                                                        </tr>--%>
                                                <tr>
                        ...
                        <ContentTemplate>
                            ...
                            <asp:GridView ID="gvAttendance" runat="server" AutoGenerateColumns="False" Width="97%"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="PAPER_CODE" HeaderText="Subject Code" />
                        ...
                        <ContentTemplate>
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <%--<td>
                                                                <asp:GridView ID="gvExamination" runat="server" Width="97%" CssClass="gridDynamic"
                                                                    AutoGenerateColumns="False" DataKeyNames="EXAM_STU_ID" OnRowCommand="gvExamination_RowCommand">
                                                                    <Columns>
                                                                        <asp:TemplateField HeaderText="S.No.">
                                                                            <ItemTemplate>
                                                                                <%# ((GridViewRow)Container).RowIndex + 1%>
                                                                        ...
                                                                        <asp:BoundField DataField="SESSION_VALUE" HeaderText="Session" />
                                                                ...
                                                                <asp:GridView ID="gvExamDetail" runat="server" Width="97%" CssClass="gridDynamic"
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:BoundField DataField="CRS_NAME" HeaderText="Paper Name" />
                                                                        <asp:BoundField DataField="MAX_INTERNAL" HeaderText="Internal Max." />
                                                                        <asp:BoundField DataField="INTERNAL_MRKS" HeaderText="Internal Gain" />
                                                                        <asp:BoundField DataField="MAX_MAJOR" HeaderText="Major Max." />
                                                                        <asp:BoundField DataField="MAJOR_MRKS" HeaderText="Major Gain" />
                                                                        <asp:BoundField DataField="total_marks" HeaderText="Max.Total" />
                                                                        <asp:BoundField DataField="total_gain" HeaderText="Total Gain" />
                                                                    </Columns>
                                                                </asp:GridView>
                                                            </td>--%>
                                </tr>
                    ...
                    <ajaxToolkit:TabPanel ID="TabPanel6" runat="server" HeaderText="Internal Marks">
                        <ContentTemplate>

                            <asp:GridView ID="gvInternalMarks" runat="server" CssClass="gridDynamic" AutoGenerateColumns="true">
                                <Columns></Columns>
                            </asp:GridView>

                        </ContentTemplate>
                    </ajaxToolkit:TabPanel>
                    <ajaxToolkit:TabPanel runat="server" HeaderText="Other Detail" ID="TabPanel5">
                        <ContentTemplate>
